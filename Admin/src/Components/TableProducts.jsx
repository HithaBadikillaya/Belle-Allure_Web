...
export default function CustomizedTables() {
  ...
  React.useEffect(() => {
    axios
      .get("http://localhost:7000/admin/getAllCategories")
      .then((response) => {
    ...
    axios
      .get("http://localhost:7000/admin/getAllProducts")
      .then((response) => {
        console.log(response.data);
 ...
 const handleUpdateModalOpen = (product) => {
  ...
  setselectedCategory(product.category_id._id); // Set the initial category ID
  setUpdateModal(true);
};
  ...
  const handleproductInsert = () => {
    ...
    if(!productInfo || !productInfo.description|| !selectedCategory|| !productInfo.quanity || !productInfo.price|| !productFile){
    ...
    axios
      .post(`http://localhost:7000/admin/Insertproduct`, formData)
      .then((response) => {
        console.log(response.data);
        setState(!state);
  ...
  const handleproductUpdate = () => {
    ...
    axios
      .put(
        `http://localhost:7000/admin/updateproduct/${selectedproduct._id}`,
        formData
      )
      .then((response) => {
        console.log(response.data);
    ...
    <div>
      ...
      <Dialog open={insertModal} onClose={handleInsertModalClose}>
        ...
        <DialogContent sx={{ width: 500 }}>
          <DialogContentText>Fill the product info</DialogContentText>
          <TextField
      ...
      <Dialog open={updateModal} onClose={handleUpdateModalClose}>
        ...
        <DialogContent sx={{ width: 500 }}>
          <DialogContentText>Update the product info</DialogContentText>
          <TextField
