...
export default function OrderDetails({ user }) {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:7000/admin/getOrder")
      .then((response) => {
  ...
  const updateOrder = (data) => {
    console.log(data);
    axios
      .put(`http://localhost:7000/admin/updateOrder/${data?._id}`)
      .then((response) => {
        console.log(response.data);
        setState(!State);
  ...
  const updateCashOrder = (data) => {
    ...
    // console.log(orderI);
    axios
      .put(`http://localhost:7000/admin/updateCashOrder/${data?._id}`, orderI)
      .then((response) => {
        console.log(response.data);
        setState(!State);
        alert(response.data.message);
  ...
  const update = (data) => {
    // console.log(data);
    axios
      .put(`http://localhost:7000/admin/updatePayment/${data?._id}`)
      .then((response) => {
        console.log(response.data);
        setState(!State);
        alert(response.data.message);
              ...
              <Table aria-label="customized table">
                ...
                <TableBody>
                  ...
                  >
                    <StyledTableCell>
                      <img
                        src={`http://localhost:7000/uploads/customer/${order?.User_id?.profile}`}
                        alt=""
                        style={{ width: "100px", height: "100px" }}
                      />
                    </StyledTableCell>
