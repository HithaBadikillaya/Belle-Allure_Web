...
return}
    ...
    axios
      .post("http://localhost:7000/admin/insertCategory", formData)
      .then((response) => {
  ...
  const handleCategoryUpdate = () => {
    ...
    axios
      .put(
        `http://localhost:7000/admin/updateCategory/${selectedCategory._id}`,
        formData
      )
      .then((response) => {
        console.log(response.data);
              ...
              <StyledTableRow key={index}>
                ...
                <StyledTableCell align="right">
                  <img
                    ...
                    src={`http://localhost:7000/uploads/category/${row?.picture}`}
                    alt="picture"
                  />
                </StyledTableCell>
